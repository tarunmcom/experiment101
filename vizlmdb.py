...
parser.add_argument('--input', type=str, default='DocTamperV1-TrainingSet')  ## path to the dataset dir, which contains data.mdb and lock.mdb
parser.add_argument('--i', type=int, default=2) # index of the image to be visualized
